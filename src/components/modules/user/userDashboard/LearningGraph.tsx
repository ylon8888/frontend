...
// Color mapping for quiz results only
const COLORS = {
...
export default function LearningGraph() {
  ...
  const {
    ...
    isLoading,
    isFetching,
  } = useGetStudentQuery(objectQuery);
  ...
  // Transform API data into format expected by Recharts - only quiz data
    ...
    <div className="w-full">
      ...
      {isLoading || isFetching ? (
        ...
        <>
          ...
          {/* Add quiz accuracy rate display */}
